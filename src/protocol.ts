...
export interface RollResult { version:1; requestId:string; expression:string; dialect:Dialect; visibility:Visibility; playerId:string; playerName:string; value:Value; trace:string[]; time:number; label?:string; source?:string; error?:string }
