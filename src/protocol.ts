...
export interface RollResult { version:1; requestId:string; expression:string; dialect:Dialect; visibility:Visibility; playerId:string; playerName:string; value:Value; interpretation?:string; trace:string[]; steps?:string[]; stepDice?:string[]; resolution?:{ast:Node;dice:DieDraw[]}; time:number; label?:string; source?:string; error?:string; verification?:VerificationRecord }
