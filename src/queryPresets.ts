...
export const QUERY_PRESETS:readonly QueryPreset[]=[
  {id:'pbta',label:'PbtA',description:'2d6 with an optional numeric modifier',pattern:String.raw`^2d6(?:[+-]\d+)?$`},
  {id:'pbta-hit',label:'PbtA 10+',description:'PbtA expression with a final result of 10 or more',pattern:String.raw`^2d6(?:[+-]\d+)?$`,result:{comparison:'>=',value:10}},
