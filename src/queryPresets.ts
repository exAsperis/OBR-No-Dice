...
/** Add a preset here; the Ledger tab renders and applies every entry automatically. */
export const QUERY_PRESETS:readonly QueryPreset[]=[
  ...
  {id:'nat-20',label:'Nat 20',description:'Any natural 20 on a d20, including modified results',pattern:'',roll:{comparison:'=',value:20,dieType:'d20'}},
  {id:'nat-1',label:'Nat 1',description:'Any natural 1 on a d20, including modified results',pattern:'',roll:{comparison:'=',value:1,dieType:'d20'}},
